...
def imageToInstructions(image):
    ...
    instructions = []
    with open("instructions/0.txt", "r") as structs0, open("instructions/1.txt", "r") as structs1, open("instructions/2.txt", "r") as structs2, \
        open("instructions/3.txt", "r") as structs3, open("instructions/4.txt", "r") as structs4, open("instructions/5.txt", "r") as structs5, \
        open("instructions/6.txt", "r") as structs6, open("instructions/7.txt", "r") as structs7, open("instructions/8.txt", "r") as structs8, \
        open("instructions/9.txt", "r") as structs9, open("instructions/negative.txt", "r") as structsNeg, open("dot.txt", "r") as structsDot:
